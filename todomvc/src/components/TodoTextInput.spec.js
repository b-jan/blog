...
describe('components', () => {
  describe('TodoTextInput', () => {
    it('should render correctly', () => {
      ...
      expect(output.props.value).toEqual('User Next.js')
    ...
    it('should call onSave on return key press', () => {
      ...
      output.props.onKeyDown({ which: 13, target: { value: 'User Next.js' } })
      expect(props.onSave).toBeCalledWith('User Next.js')
    })
    ...
    it('should call onSave on blur', () => {
      const { output, props } = setup()
      output.props.onBlur({ target: { value: 'User Next.js' } })
      expect(props.onSave).toBeCalledWith('User Next.js')
    })
