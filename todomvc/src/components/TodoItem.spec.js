...
describe('components', () => {
  describe('TodoItem', () => {
    it('initial render', () => {
      ...
      expect(label.props.children).toBe('User Next.js')
    ...
    it('edit state render', () => {
      ...
      expect(input.props.text).toBe('User Next.js')
      expect(input.props.editing).toBe(true)
    })

    it('TodoTextInput onSave should call editTodo', () => {
      const { output, props } = setup(true)
      output.props.children.props.onSave('User Next.js')
      expect(props.editTodo).toBeCalledWith(0, 'User Next.js')
    })
